...
#ifndef _SNET_ADDRESS_H_
#define _SNET_ADDRESS_H_
...
namespace lib_linux
{
    ...
    class Address
    {
        public:
            ...
            /// = sockaddr_in
            const Address &operator = ( const struct sockaddr_in &addr )
            {
                _addr = addr;
                return *this;
            }
    ...
    {
        struct sockaddr_in _addr1 = addr1;
        struct sockaddr_in _addr2 = addr2;
